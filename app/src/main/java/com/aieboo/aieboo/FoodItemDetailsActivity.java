...
/**
 * A food item detail activity.
 */
public class FoodItemDetailsActivity extends Activity {
    static final String PACKAGE = "com.aieboo.FoodItemDetailsActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(
                getResources(), bundle.getInt(PACKAGE + ".resourceId"));
    ...
    public void runEnterAnimation() {
        ...
        ObjectAnimator colorizer = ObjectAnimator.ofFloat(FoodItemDetailsActivity.this,
                "saturation", 0, 1);
                ...
                withEndAction(new Runnable() {
                    public void run() {
                        ...
                        ObjectAnimator colorizer =
                                ObjectAnimator.ofFloat(FoodItemDetailsActivity.this,
                                        "saturation", 1, 0);
                        colorizer.setDuration(duration);
                        colorizer.start();
                    }
